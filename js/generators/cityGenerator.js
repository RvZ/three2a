...
export class CityGenerator {
  ...
  createRoadNetwork(scene, totalBlockSize, roadWidth, sidewalkWidth, citySize) {
    ...
    for (let z = 0; z < citySize + 1; z++) {
      ...
      const roadGeometry = new THREE.PlaneGeometry(
        citySize * totalBlockSize + roadWidth,
        roadWidth,
      );
      ...
      if (z < citySize) {
        // No sidewalk at the very edge of the city
        // North sidewalk
        const northSidewalkGeometry = new THREE.PlaneGeometry(
          citySize * totalBlockSize + roadWidth,
          sidewalkWidth,
        );
      ...
      if (z > 0) {
        // No sidewalk at the very edge of the city
        // South sidewalk
        const southSidewalkGeometry = new THREE.PlaneGeometry(
          citySize * totalBlockSize + roadWidth,
          sidewalkWidth,
        );
    ...
    for (let x = 0; x < citySize + 1; x++) {
      ...
      if (x < citySize) {
        // No sidewalk at the very edge of the city
        // East sidewalk
        const eastSidewalkGeometry = new THREE.PlaneGeometry(
          sidewalkWidth,
          citySize * totalBlockSize + roadWidth,
        );
      ...
      if (x > 0) {
        // No sidewalk at the very edge of the city
        // West sidewalk
        const westSidewalkGeometry = new THREE.PlaneGeometry(
          sidewalkWidth,
          citySize * totalBlockSize + roadWidth,
        );
  ...
  addParkedCars(scene, totalBlockSize, roadWidth, sidewalkWidth, citySize) {
    ...
    for (let i = 0; i < carCount; i++) {
      ...
      const position = this.getRandomParkingPosition(
        totalBlockSize,
        roadWidth,
        sidewalkWidth,
        citySize,
  ...
  addPedestrians(scene, totalBlockSize, roadWidth, sidewalkWidth, citySize) {
    ...
    for (let i = 0; i < pedestrianCount; i++) {
      ...
      const position = this.getRandomSidewalkPosition(
        totalBlockSize,
        roadWidth,
        sidewalkWidth,
        citySize,
